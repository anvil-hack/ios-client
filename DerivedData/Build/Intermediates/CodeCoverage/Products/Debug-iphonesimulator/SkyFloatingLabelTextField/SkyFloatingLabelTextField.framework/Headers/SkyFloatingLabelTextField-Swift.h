...
/**
  A UIColor value that determines the color used for the title label and line when the error message is not \code
  nil
  \endcode
*/
...
/**
  The internal \code
  UILabel
  \endcode that displays the selected, deselected title or error message based on the current state.
*/
