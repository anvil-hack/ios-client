...
SWIFT_CLASS("_TtC10Mockingjay18MockingjayProtocol")
@interface MockingjayProtocol : NSURLProtocol
/**
...
@interface NSURLSessionConfiguration (SWIFT_EXTENSION(Mockingjay))
/**
  Swizzles NSURLSessionConfiguration’s default and ephermeral sessions to add Mockingjay
*/
+ (void)mockingjaySwizzleDefaultSessionConfiguration;
@end


@interface XCTest (SWIFT_EXTENSION(Mockingjay))
/**
  Whether Mockingjay should remove stubs on teardown
*/
@property (nonatomic) BOOL mockingjayRemoveStubOnTearDown;
- (void)removeAllStubs;
+ (void)mockingjaySwizzleTearDown;
@end
